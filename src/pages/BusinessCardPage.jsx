...
const BusinessCardPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#1A1A1A] flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 px-6 py-8 md:py-16 overflow-y-auto relative z-10">
        {/* Page Title */}
        <motion.h1 
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-[#CCC1BE] tracking-tight mb-8 text-center">
            Watch Our Videos
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* SmartFitter Introduction Video */}
            <motion.div 
              className="bg-gradient-to-br from-[#232323] to-[#1A1A1A] border border-[#CCC1BE]/20 rounded-lg overflow-hidden hover:border-[#CCC1BE]/40 transition-all duration-300"
              whileHover={{ scale: 1.02 }}
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold text-[#CCC1BE] mb-2">SmartFitter Introduction</h3>
                <p className="text-sm text-[#E5E7EB]/70">Learn about our executive program and how to become an international executive</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-lg font-semibold text-[#CCC1BE] mb-2">Success Stories</h3>
                <p className="text-sm text-[#E5E7EB]/70">Hear from our global executives and their transformation stories</p>
              </div>
            </motion.div>
          </div>
        </motion.section>
        ...
        {/* Promotional Content */}
        <section className="pt-4 max-w-6xl mx-auto">
          <motion.h1 
          ...
          <motion.div 
            className="w-full h-80 md:h-96 bg-[#1A1A1A]/50 rounded-2xl mb-8 overflow-hidden relative"
